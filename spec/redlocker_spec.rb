  ...
  RSpec.describe Client do
    describe '#lock' do
      ...
      it 'acquires the lock and calls the block' do
        ...
        described_class.new(redis: redis).lock(name: 'some_lock', timeout: 3) do
      ...
      it 'uses the specified namespace' do
        ...
        described_class.new(redis: redis, namespace: 'some_namespace').lock(name: 'some_lock', timeout: 3) do
      ...
      it 'releases the lock when block raises' do
        ...
        begin
          client.lock(name: 'some_lock', timeout: 3) do
            raise 'error'
          end
      ...
      it 'raises a TimeoutError when the lock can not be acquired' do
        ...
        expect do
          client.lock(name: 'some_lock', timeout: 2) do
            # nothing
          end
      ...
      it 'uses the specified delay while acquiring the lock' do
        ...
        client.lock(name: 'some_lock', timeout: 3, delay: 0.8) do
